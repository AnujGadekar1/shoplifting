...
def detect_shoplifting(video_path):
    model_yolo = YOLO(r"C:\Users\Anuj\Downloads\Work_1\Suspicious-Activity-Detection-master\Suspicious-Activity-Detection-master\best.pt")
    model = xgb.Booster()
    model.load_model(r"C:\Users\Anuj\Downloads\Work_1\Suspicious-Activity-Detection-master\Suspicious-Activity-Detection-master\model_weights.json")
    ...
    output_path = fr"C:\Users\Anuj\Downloads\Work_1\Suspicious-Activity-Detection-master\Suspicious-Activity-Detection-master\{video_name}_output.mp4"
...
# Example usage:
video_path = r"C:\Users\Anuj\Downloads\Work_1\Suspicious-Activity-Detection-master\Suspicious-Activity-Detection-master\istockphoto-1391833001-640_adpp_is.mp4"
