...
df = pd.read_csv(r'C:\Users\Anuj\Work_2\shop1-main\dataset_path\dataset_pathdataset.csv')
...
model.save_model(r"C:\Users\Anuj\Work_2\shop1-main\trained_model.json")
